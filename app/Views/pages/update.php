        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="fullname" id="fullname" value="<?php echo session()->get('fullname'); ?>" />
              <label for="username">User name:</label>
              <input type="text" class="form-control" name="username" id="username" value="<?php echo session()->get('username'); ?>" />
              ...
              <input type="date" class="form-control" name="date_of_birth" id="date_of_birth" value="<?php echo session()->get('date_of_birth'); ?>" />
              <label for="phone_number">Phone:</label>
              <input type="text" class="form-control" name="phone_number" id="phone_number" value="<?php echo session()->get('phone_number'); ?>" />
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
